...
class HBSMAT:
    ...
    def compute_ULV(self):
        self.Q1list,self.Q2list,self.W1list,self.W2list,self.Uulist,self.Rlist,self.R_off_list,self.NNvec = ULVsparse.compute_ULV(self.Umats,self.Dmats,self.Vmats,self.Nbvec)
